                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.contact-contacts.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('contact_city') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="contact_city" id="contact_city" value="{{ old('contact_city', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('contact_fb') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="contact_fb" id="contact_fb" value="{{ old('contact_fb', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('contact_ins') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="contact_ins" id="contact_ins" value="{{ old('contact_ins', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('contact_tw') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="contact_tw" id="contact_tw" value="{{ old('contact_tw', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('contact_vk') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="contact_vk" id="contact_vk" value="{{ old('contact_vk', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('open_hour') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control timepicker" type="text" name="open_hour" id="open_hour" value="{{ old('open_hour') }}">
                        ...
                        <div class="form-group {{ $errors->has('close_hour') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control timepicker" type="text" name="close_hour" id="close_hour" value="{{ old('close_hour') }}">
                        ...
                        <div class="form-group {{ $errors->has('head_script') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="head_script" id="head_script" value="{{ old('head_script', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('body_script_top') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="body_script_top" id="body_script_top" value="{{ old('body_script_top', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('body_script_bottom') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="body_script_bottom" id="body_script_bottom" value="{{ old('body_script_bottom', '') }}">
