                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.menus.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('anchor_key') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="anchor_key" id="anchor_key" value="{{ old('anchor_key', '') }}" required>
                        ...
                        {{--<div class="form-group {{ $errors->has('excerpt') ? 'has-error' : '' }}">--}}
                            {{--<label for="excerpt">{{ trans('cruds.menu.fields.excerpt') }}</label>--}}
                            ...
                            {{--@endif--}}
                            {{--<span class="help-block">{{ trans('cruds.menu.fields.excerpt_helper') }}</span>--}}
                        {{--</div>--}}
