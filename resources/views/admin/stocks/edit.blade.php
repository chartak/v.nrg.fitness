                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.stocks.update", [$stock->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $stock->name) }}" required>
                            @if($errors->has('name'))
                        ...
                        <div class="form-group {{ $errors->has('start_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="start_date" id="start_date" value="{{ old('start_date', $stock->start_date) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('end_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="end_date" id="end_date" value="{{ old('end_date', $stock->end_date) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('orderby') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" min="1" oninput="this.value = Math.abs(this.value)" name="orderby" id="orderby" value="{{ old('orderby', $stock->orderby) }}" step="1" required>
                        ...
                        <div class="form-group {{ $errors->has('status') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="status" id="status" value="1" {{ $stock->status || old('status', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group {{ $errors->has('discounts') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="discounts" id="discounts" value="{{ old('discounts', $stock->discounts) }}" step="1">
                        ...
                        <div class="form-group {{ $errors->has('branch') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="branch_id" id="branch_id" required>
                                @foreach($branches as $id => $branch)
                                    <option value="{{ $id }}" {{ ($stock->branch ? $stock->branch->id : old('branch_id')) == $id ? 'selected' : '' }}>{{ $branch }}</option>
                                @endforeach
                            </select>
