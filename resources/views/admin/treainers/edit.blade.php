                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <div class="form-group {{ $errors->has('status') ? 'has-error' : '' }}">
                                    <div>
                                        ...
                                        <input type="checkbox" name="status" id="status" value="1" {{ $treainer->status || old('status', 0) === 1 ? 'checked' : '' }}>
                                        <label for="status" style="font-weight: 400">{{ trans('cruds.treainer.fields.status') }}</label>
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group {{ $errors->has('schedule_trainer') ? 'has-error' : '' }}">
                                    <div>
                                        ...
                                        <input type="checkbox" name="schedule_trainer" id="schedule_trainer" value="1" {{ $treainer->schedule_trainer || old('schedule_trainer', 0) === 1 ? 'checked' : '' }}>
                                        <label for="schedule_trainer" style="font-weight: 400">{{ trans('cruds.treainer.fields.schedule_trainer') }}</label>
                                    </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group {{ $errors->has('orderby') ? 'has-error' : '' }}">
                                    ...
                                    <input class="form-control" type="number" min="1" oninput="this.value = Math.abs(this.value)" name="orderby" id="orderby" value="{{ old('orderby', $treainer->orderby) }}" step="1" required>
