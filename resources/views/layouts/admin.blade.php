    ...
    <div class="wrapper" style="height: auto; min-height: 100%;">
        <header class="main-header">
            ...
            <nav class="navbar navbar-static-top">
                ...
                <audio id="myAudio">
                    <source src="{{url('/audio/graceful.mp3')}}" type="audio/mpeg">
                </audio>
                <li class="fa-fw fas" id="new-order">
                    <a class="navbar-brand" href="" aria-haspopup="true" aria-expanded="false">
        ...
        <footer class="main-footer text-center">
            ...
            {{--&copy; {{ trans('global.allRightsReserved') }}--}}
        </footer>
