...
<!--phone menu popup-->
<div class="menuphone ui-modal--active ui-modal--visible ui-modal--overlay-closer ui-modal--zoom">
    <div class="ui-modal-overlay ui-modal-overlay--closer clmenuph" style="min-height: 100%;min-width: 100%;transition-duration:600ms;"></div>
    <div class="ui-modal-place" style="animation-duration:600ms;">
        <div class="ui-modal-contentphone">
        <div class="ui-modal-content">
            <div class="ui-modal-content-inner">
                <div data-v-e24b8bd8="" class="rf-wrapper">
                    <header data-v-e24b8bd8="" class="rf-header">
                        <div data-v-00edd878="" data-v-e24b8bd8="" class="closer cloasepopphone">
                            <div data-v-00edd878="" class="closer-icon"></div>
                        </div>
                        <h3 data-v-e24b8bd8="">Мы перезвоним Вам в ближайшее время!</h3></header>
                    <div data-v-e24b8bd8="" class="rf-content">
                        <form action="" id="menuPhoneForm" method="post" name="menuPhoneForm">
                        <div data-v-e24b8bd8="" class="form">
                            <div data-v-e24b8bd8="" class="form-topdata"></div>
                            <div data-v-e24b8bd8="" class="form-item">
                                <input type="hidden" value="1" name="menu_phone_type_id" id="menuPhoneTypeId">
                                <input type="hidden" value="Menu Phone" name="menuPhoneSignUpType" id="menuPhoneSignUpType">
                                <input type="hidden" value="Меню телефона" name="menuPhoneSignUpTypeRu">
                            ...
                            <div data-v-e24b8bd8="" class="form-item">
                                <div data-v-a01fbd60="" class="ui-input telhid" data-vv-as="Номер телефона" data-v-e24b8bd8="">
                                    <div data-v-a01fbd60="" class="ui-input-control-wrapper">
                            ...
                            <div data-v-e24b8bd8="" class="form-buttons">
                                <button data-v-49615d1c="" type="button" class="ui-btn form-buttons-send" id="formButtonSendMenuPhone"
                                        data-v-e24b8bd8="">Перезвоните мне
                                </button>
                            </div>
                        </div>
                        </form>
                        <div data-v-8fe9dfde="" class="thank-you" data-v-e24b8bd8="">
                            <div data-v-8fe9dfde="" class="thank-you-content">
                                ...
                                <div data-v-8fe9dfde="" class="thank-you-header"><p data-v-8fe9dfde="">Спасибо!</p>
                                    <p data-v-8fe9dfde="">Ваша заявка успешно принята.</p></div>
                                <div data-v-8fe9dfde="" class="thank-you-text">В ближайшее время наши менеджеры свяжутся
                                    с Вами.
                                </div>
                            </div>
                        </div>
